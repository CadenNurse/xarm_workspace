...
from .xarm_workspace_env_cfg import XarmWorkspaceEnvCfg  



class XarmWorkspaceEnv(DirectRLEnv):
    ...
    cfg: XarmWorkspaceEnvCfg

    def __init__(self, cfg: XarmWorkspaceEnvCfg, render_mode: str | None = None, **kwargs):
        ...
        self.robot_dof_speed_scales[self._robot.find_joints("drive_joint")[0]] = 0.1
