...
All the environments are registered in the `xarm_workspace` extension. They start
...
import xarm_workspace.tasks  # noqa: F401

# PLACEHOLDER: Extension template (do not remove this comment)
with contextlib.suppress(ImportError):
    import xarm_workspace.tasks_experimental  # noqa: F401
...
def _format_presets(preset_map: dict | None) -> str:
    ...
    Args:
        preset_map: Mapping of :class:`~xarm_workspace.utils.preset_target.PresetTarget`
    ...
    if preset_map is None:
        return "(unavailable)"
    from xarm_workspace.utils.preset_target import PresetTarget
